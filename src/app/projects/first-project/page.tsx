            ...
            <section className='bg-gray-100 h-full w-full md:m-auto pt-14 pb-14 md:flex md:flex-col md:justify-start md:px-20 lg:px-60'>
                ...
                <div className='mt-12 lg:mb-5'>
                    ...
                    <div className='flex flex-col justify-start md:flex-row md:items-center'>
                        <button onClick={() => router.push("https://github.com/FACUNDEZ/chat-app")} className="block ml-5 rounded mt-7 lg:mt-9 md:my-6 shadow-md bg-cyan-500 text-white text-lg font-bold py-3 w-2/6 md:max-w-xs hover:bg-cyan-600 hover:translate-x-3 md:hover:-translate-y-3 md:hover:translate-x-0 duration-500">Repository</button>
