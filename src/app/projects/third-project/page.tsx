        ...
        <>
            ...
            <main className="h-full flex items-center justify-center overflow-hidden">
                <section className="bg-cover bg-center w-full pt-48 pb-40 md:pt-48 md:pb-40 lg:pt-52 lg:pb-44" style={{ backgroundImage: "url('/images/background.webp')" }}>
                    <h1 className="text-center text-5xl md:text-6xl lg:text-7xl font-bold leading-snug animate-translateX">{'<'} E-COMMERCE {">"}</h1>
                    <hr className='mt-3 rounded w-16 md:w-24 m-auto border-4 border-cyan-500 animate-bounceX' />
                    <p className="text-center text-lg md:text-xl lg:text-2xl mt-12 lg:mt-16 mx-2 tracking-wider animate-translateXR">I wrote a description in this page for you telling about my ecommerce project that I made with the Fake Store Api. I hope you enjoy it so much!</p>
            ...
            <section className='bg-gray-100 h-full w-full md:m-auto pt-14 pb-14 md:flex md:flex-col md:justify-start md:px-20 lg:px-60'>
                ...
                <p className='mx-5 mt-5 md:mt-7 leading-6 text-sm md:text-base'>Immerse yourself in a unique online shopping experience with our fullstack app, designed with the powerful Fake Store API. Explore an extensive catalog ranging from fashion to home goods, always up-to-date thanks to seamless integration with Fake Store. My platform offers a complete approach thanks to its fullstack architecture, providing you not only with an attractive user interface, but also with advanced functionalities that improve your shopping experience.</p><br />
                <p className='mx-5 leading-6 text-sm md:text-base'> Secure authentication is a fundamental part of this e-commerce. Your data is protected with a robust authentication system, giving you confidence throughout your experience on the platform. Dynamic routes allow you to explore intuitively, making navigation easier and optimizing your search time. Additionally, I have implemented an efficient shopping cart that simplifies the purchasing process, along with secure payment methods to ensure transactions without problems.</p><br />
                <p className='mx-5 leading-6 text-sm md:text-base'>In this e-commerce, you not only buy products, but you also have a complete experience. From authentication to payment finishing. Join us and experience the perfect fusion of fullstack technology. Discover the future of e-commerce with this project!</p>
                <div className='mt-12'>
                    ...
                    <div className='flex justify-start ml-5 flex-wrap gap-2 md:gap-3 lg:mt-9'>
                        ...
                        <span className='bg-zinc-200 text-zinc-600 py-2 px-3 max-w-sm rounded font-bold md:text-base lg:text-lg'>Typescript</span>
                ...
                <div className='mt-12 lg:mb-5'>
                    ...
                    <div className='flex flex-col justify-start md:flex-row md:items-center'>
                        <button onClick={() => router.push("https://github.com/FACUNDEZ/ecommerce-diplomatura")} className="block ml-5 rounded mt-7 lg:mt-9 md:my-6 shadow-md bg-cyan-500 text-white text-lg font-bold py-3 w-2/6 md:max-w-xs hover:bg-cyan-600 hover:translate-x-3 md:hover:-translate-y-3 md:hover:translate-x-0 duration-500">Repository</button>
