        ...
        <>
            ...
            <main className="h-full flex items-center justify-center overflow-hidden">
                <section className="bg-cover bg-center w-full pt-48 pb-40 md:pt-48 md:pb-40 lg:pt-52 lg:pb-44" style={{ backgroundImage: "url('/images/background.webp')" }}>
                    <h1 className="text-center text-5xl md:text-6xl lg:text-7xl font-bold leading-snug animate-translateX">{'<'} VIDEO CALL {">"}</h1>
                    <hr className='mt-3 rounded w-16 md:w-24  m-auto border-4 border-cyan-500 animate-bounceX' />
                    <p className="text-center text-lg md:text-xl lg:text-2xl mt-12 lg:mt-16 mx-2 tracking-wider animate-translateXR">I wrote a description in this page for you telling about my video call project that I made. I hope you enjoy it so much!</p>
            ...
            <section className='bg-gray-100 h-full w-full md:m-auto pt-14 pb-14 md:flex md:flex-col md:justify-start md:px-20 lg:px-60'>
                ...
                <p className='mx-5 mt-5 md:mt-7 leading-6 text-sm md:text-base'>My comprehensive video calling app, developed in collaboration with my colleagues, provides a complete and secure experience for users. We have carefully designed the login and registration process to ensure maximum data security and privacy. The application has a real-time video calling system supported by fullstack technology, allowing for dynamic and fluid interaction between users.</p><br />
                <p className='mx-5 leading-6 text-sm md:text-base'>Our platform not only offers high-quality video calls, but also distinguished by call history, providing a real-time view of activity on the platform. Additionally, we have strengthened authentication by implementing tokens, further strengthening the security of the system and protecting the identity of users.</p><br />
                <p className='mx-5 leading-6 text-sm md:text-base'>In short, our video calling app not only focuses on security and privacy, but also strives to provide an efficient, reliable and easy-to-use platform, created in collaboration with talented colleagues to meet all your video communication needs online.</p>
                <div className='mt-12'>
                    ...
                    <div className='flex justify-start ml-5 flex-wrap gap-2 md:gap-3 lg:mt-9'>
                        ...
                        <span className='bg-zinc-200 text-zinc-600 py-2 px-3 max-w-sm rounded font-bold md:text-base lg:text-lg'>Firebase</span>
                        <span className='bg-zinc-200 text-zinc-600 py-2 px-3 max-w-sm rounded font-bold md:text-base lg:text-lg'>Video RTC</span>
                ...
                <div className='mt-12 lg:mb-5'>
                    ...
                    <div className='flex flex-col justify-start md:flex-row md:items-center'>
                        <button onClick={() => router.push("https://github.com/OktoCall/oktocall")} className="block ml-5 rounded mt-7 lg:mt-9 md:my-6 shadow-md bg-cyan-500 text-white text-lg font-bold py-3 w-2/6 md:max-w-xs hover:bg-cyan-600 hover:translate-x-3 md:hover:-translate-y-3 md:hover:translate-x-0 duration-500">Repository</button>
