        ...
        <section id='about-me' className='h-auto bg-gray-100'>
            ...
            <div className='lg:flex lg:justify-center lg:gap-10 lg:mx-4 md:mt-4'>
                <div className='pb-10 mt-14 lg:w-6/12 lg:mt-14'>
                    ...
                    <button className="block mt-14 lg:mt-12 ml-4 lg:mb-5 shadow-md rounded bg-cyan-500 text-white text-xl font-bold px-4 py-3 hover:bg-cyan-600 hover:-translate-y-3 duration-500">Contact Me</button>
                </div>
